    ...
    public void create(Pessoa pessoa) {
        ...
        try {
            ...
            if (pessoaFisica != null) {
                pessoaFisica = em.getReference(pessoaFisica.getClass(), pessoaFisica.getFKPessoaid());
                pessoa.setPessoaFisica(pessoaFisica);
            }
            PessoaJuridica pessoaJuridica = pessoa.getPessoaJuridica();
            if (pessoaJuridica != null) {
                pessoaJuridica = em.getReference(pessoaJuridica.getClass(), pessoaJuridica.getFKPessoaid());
            ...
            for (Movimento movimentoCollectionMovimento : pessoa.getMovimentoCollection()) {
                Pessoa oldIdPessoaOfMovimentoCollectionMovimento = movimentoCollectionMovimento.getFKPessoaid();
                movimentoCollectionMovimento.setFKPessoaid(pessoa);
    ...
    public void edit(Pessoa pessoa) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (pessoaFisicaNew != null) {
                pessoaFisicaNew = em.getReference(pessoaFisicaNew.getClass(), pessoaFisicaNew.getFKPessoaid());
                pessoa.setPessoaFisica(pessoaFisicaNew);
            }
            if (pessoaJuridicaNew != null) {
                pessoaJuridicaNew = em.getReference(pessoaJuridicaNew.getClass(), pessoaJuridicaNew.getFKPessoaid());
            ...
            for (Movimento movimentoCollectionNewMovimento : movimentoCollectionNew) {
                if (!movimentoCollectionOld.contains(movimentoCollectionNewMovimento)) {
                    Pessoa oldIdPessoaOfMovimentoCollectionNewMovimento = movimentoCollectionNewMovimento.getFKPessoaid();
                    movimentoCollectionNewMovimento.setFKPessoaid(pessoa);
