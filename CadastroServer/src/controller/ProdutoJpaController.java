    ...
    public void create(Produto produto) {
        ...
        try {
            ...
            for (Movimento movimentoCollectionMovimento : produto.getMovimentoCollection()) {
                Produto oldIdProdutoOfMovimentoCollectionMovimento = movimentoCollectionMovimento.getFKProdutoid();
                movimentoCollectionMovimento.setFKProdutoid(produto);
        ...
        try {
            ...
            for (Movimento movimentoCollectionNewMovimento : movimentoCollectionNew) {
                if (!movimentoCollectionOld.contains(movimentoCollectionNewMovimento)) {
                    Produto oldIdProdutoOfMovimentoCollectionNewMovimento = movimentoCollectionNewMovimento.getFKProdutoid();
                    movimentoCollectionNewMovimento.setFKProdutoid(produto);
